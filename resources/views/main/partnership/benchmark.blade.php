@section('meta_tag')
    ...
    <title>Benchmark | HMTI Telkom University</title>
@endsection
        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center">
                <div class="mb-6 text-center">
                    <flux:heading size="4xl" level="2" accent="disableDarkMode">Benchmark</flux:heading>
                </div>
                <flux:breadcrumbs>
                    ...
                    <flux:breadcrumbs.item disableDarkMode="true">Benchmark</flux:breadcrumbs.item>
                </flux:breadcrumbs>
            </div>
        </div>
    </section>

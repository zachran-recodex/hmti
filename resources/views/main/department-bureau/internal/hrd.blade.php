@section('meta_tag')
    ...
    <title>Human Resource Department | HMTI Telkom University</title>
@endsection
        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center">
                <div class="mb-6 text-center">
                    <flux:heading size="4xl" level="2" accent="disableDarkMode">Human Resource Departement</flux:heading>
                </div>
                <flux:breadcrumbs>
                    ...
                    <flux:breadcrumbs.item disableDarkMode="true">Human Resource Departement</flux:breadcrumbs.item>
                </flux:breadcrumbs>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto py-8 sm:py-12 md:py-16">
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col items-center space-y-6">
                    ...
                    <flux:heading size="4xl" level="2">Human Resource Department</flux:heading>

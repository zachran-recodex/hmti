@section('meta_tag')
    ...
    <title>Struktur HMTI | HMTI Telkom University</title>
@endsection
        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center">
                <div class="mb-6 text-center">
                    <flux:heading size="4xl" level="2" accent="disableDarkMode">Struktur HMTI</flux:heading>
                </div>
                <flux:breadcrumbs>
                    ...
                    <flux:breadcrumbs.item disableDarkMode="true">Struktur HMTI</flux:breadcrumbs.item>
                </flux:breadcrumbs>
            </div>
        </div>
    </section>
